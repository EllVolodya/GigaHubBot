...
public class StoreBot extends TelegramLongPollingBot {
    ...
    //Права
    private final List<Long> ADMINS = List.of(620298889L, 1030917576L, 533570832L, 404670376L);// тут айді продавців меню
    private final List<Long> DEVELOPERS = List.of(620298889L, 1030917576L, 533570832L, 404670376L, 1181804630L); // тут айді розробників меню
